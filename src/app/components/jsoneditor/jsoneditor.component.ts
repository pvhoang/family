...
import JSONEditor from '../../../assets/js/jsoneditor.js';
...
export class JsonEditorComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  jsonChange: EventEmitter<any> = new EventEmitter<any>();
	// @Output()
  // autocomplete: EventEmitter<any> = new EventEmitter<any>();
  @Input() debug = false;
  ...
  ngOnInit() {
    ...
    // if (this.debug)
		// 	console.log('JSONEDITOR optionsBefore: ', optionsBefore);
    ...
    // if (this.debug)
    //   console.log('JSONEDITOR optionsCopy: ', optionsCopy, this._data);
    ...
    // if (this.debug)
		// 	console.log('JSONEDITOR optionsCopy: ', optionsCopy);

    this.editor = new JSONEditor(this.jsonEditorContainer.nativeElement, optionsCopy, this._data);

		// if (this.debug)
		// 	console.log('JSONEDITOR expandAll: ', this.options.expandAll);
