...
export class IvyPinch {
    ...
    handleTouchstart = (event: any) => {
			...
			// console.log('handleTouchstart - event: ', event, this.eventType);
    ...
    handleTouchend = (event: any) => {
			...
			// console.log('handleTouchend - event: ', event, this.eventType);
    ...
    resetScale() {
				console.log('resetScale: ', this.scale);
				// if (this.scale == 2)
				// 	this.scale = 0.5;
    ...
    getImageElement() {
		...
		// setZoomByScale(newScale: number) {

		// 	console.log('setZoomByScale - scale, maxScale, newScale: ', this.scale, this.maxScale, newScale);
		...
		// 	console.log('setZoomByScale - getElementPosition: ', this.elementPosition);
		// 	console.log('setZoomByScale - initialMoveX, initialMoveY: ', this.initialMoveX, this.initialMoveY);

		// 	let nodeId = '1-1';
		// 	let ele = document.getElementById(nodeId);
		// 	console.log('setZoomByScale - ele: ', ele);
		// 	console.log('setZoomByScale - ele.clientHeight, clientWidth: ', ele.clientHeight, ele.clientWidth);
		// 	console.log('setZoomByScale - ele.clientTop, clientLeft: ', ele.clientTop, ele.clientLeft);
    //     // const dashboardHeight = ele.clientHeight;
    //     // const dashboardWidth = ele.clientWidth;
			
		// 	this.scrollToElement(nodeId);
		// 	// console.log('setZoomByScale - ele.clientHeight, clientWidth: ', ele.clientHeight, ele.clientWidth);
		// 	// console.log('setZoomByScale - ele.clientTop, clientLeft: ', ele.clientTop, ele.clientLeft);
			
		// 	let clientX = ele.clientLeft;
		// 	let clientY = ele.clientTop;

		// 	let xCenter = clientX - this.elementPosition.left - this.initialMoveX;
		// 	let yCenter = clientY - this.elementPosition.top - this.initialMoveY;
